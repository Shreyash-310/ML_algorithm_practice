...
print('The predicted salary of a person by Linear Regression at 6.5 Level is ', New_salary_pred)
...
print('The predicted salary of a person by Polynomial Regression at 6.5 Level is ', new_salary_pred)
